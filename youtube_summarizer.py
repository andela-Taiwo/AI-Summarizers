...
class YoutubeSummarizers:
    def __init__(self, llm_type:str="openai", llm_model_name:str="gpt-4", embedding_type="openai"):
...
def main():
    urls = ["https://www.youtube.com/watch?v=dHLXfm9TKac", "https://www.youtube.com/watch?v=NGC2PQtfXe8"]
